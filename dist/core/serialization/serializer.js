...
class EntitySerializer {
     ...
     */
    serializeArray(entities, options = {}) {
     ...
     */
    addToJSONMethod(entityClass) {
        const originalPrototype = entityClass.prototype;
        originalPrototype.toJSON = function (options = {}) {
     ...
     */
    removeCircularReferences(obj, maxDepth = 10) {
        const visited = new Set();
        const removeCircular = (value, depth) => {
            if (depth >= maxDepth) {
                return '[Max Depth Reached]';
            }
